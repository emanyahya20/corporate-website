            ...
            <div className="overflow-hidden">
              {hoverMission ? (
                <p className="text-base text-gray-700">
                  ...
                  institutions to manage wealth, transact seamlessly, and
                  protect their legacy with absolute confidence.
                </p>
              ) : (
                <p className="text-base text-gray-700">
                  At Trustmore, our mission is to reshape the human relationship
              ...
              {hoverVision ? (
                <div>
                  <p className="text-base text-gray-700 mb-3">
                    ...
                    passed on with clarity, dignity, and ease.
                  </p>
                  <p className="text-base text-gray-700 mb-3">
                    We aim to be the world's most trusted partner for wealth,
                    payments, and purpose-driven capital.
                  </p>
                  <p className="text-base text-gray-700">

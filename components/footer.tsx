      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-600">
              We combine the power of financial technology with world-class private wealth expertise to create an
              ecosystem where money moves intelligently, wealth grows strategically, and luxury is experienced
              effortlessly.
            </p>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link
                  ...
                  className={`font-medium ${
                    pathname === "/payments" ? "text-blue-600" : "text-gray-700 hover:text-blue-600"
                  }`}
                >
                  Payments
                </Link>
              ...
              <li>
                <Link
                  ...
                  className={`font-medium ${
                    pathname === "/wealth-management" ? "text-blue-600" : "text-gray-700 hover:text-blue-600"
                  }`}
                >
                  Wealth Management
                </Link>
              ...
              <li>
                <Link
                  href="/experiences"
                  className={`font-medium ${
                    pathname === "/experiences" ? "text-blue-600" : "text-gray-700 hover:text-blue-600"
                  }`}
                >
                  Experiences
                </Link>
              ...
              <li>
                <Link href="/privacy-policy" className="font-medium text-gray-700 hover:text-blue-600">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms-of-service" className="font-medium text-gray-700 hover:text-blue-600">
                  Terms of Service
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg mx-auto text-center">
          <p className="text-xs text-gray-600">
            Your Trustmore digital services are provided through licensed financial institutions. We follow necessary
            security standards and best practices.
            <span className="block">
              Trustmore itself is not a bank and doesn't hold or claim to hold a banking license.
            </span>
          </p>
        </div>

        <div className="border-t border-gray-200 mt-12 pt-8 text-center text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} Trustmore Technologies Private Limited. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
